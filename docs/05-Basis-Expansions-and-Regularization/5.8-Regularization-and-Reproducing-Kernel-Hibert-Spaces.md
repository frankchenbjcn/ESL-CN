...
| 原文   | [The Elements of Statistical Learning](https://esl.hohoweiya.xyz/book/The%20Elements%20of%20Statistical%20Learning.pdf#page=188) |
| ---- | ---------------------------------------- |
| 翻译   | szcf-weiya                               |
| 发布 | 2017-06-09 |
...
!!! note "weiya 注: 核再生性质 (kernel reproducing property)"
    ...
    $$
    这称为 **核再生性质 (kernel reproducing property)**．另外，对于任意半正定核 $K$，存在唯一的希尔伯特空间 $\cal H$ 满足核再生性质，此时 $\cal H$ 也被称之为 RKHS.
